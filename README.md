...
This repository is a source code of IOS mobile app which was written by using Swift. Swift is a powerful and intuitive programming language for all Apple platforms. Swift code is safe by design and produces software that runs lightning‑fast. Swift is also officially supported by Apple so it is a good choice for Apple platforms. 
